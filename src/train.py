...
parser.add_argument('--combine', metavar='CHARS', type=int, default=99999, help='Concatenate input files with <|endoftext|> separator into chunks of this minimum size')
...
parser.add_argument('--twremat', default=True, action='store_true', help='Use tensor rematerialization (better than memory_saving_gradients and works with tensorflow 2.0).')
parser.add_argument('--twremat_memlimit', type=str, default='32G', help='Memory usage limit/target for twremat. Can be an integer, or an integer suffixed with K/M/G for kilo/mega/giga-bytes.')
...
parser.add_argument('--sample_every', metavar='N', type=int, default=74, help='Generate samples every N steps')
parser.add_argument('--sample_length', metavar='TOKENS', type=int, default=100, help='Sample this many tokens')
parser.add_argument('--sample_num', metavar='N', type=int, default=1, help='Generate this many samples')
parser.add_argument('--save_every', metavar='N', type=int, default=37, help='Write a checkpoint every N steps')
...
def main():
    ...
    with tf.Session() as sess:
        ...
        print('Loading from the last saved checkpoint...', ckpt)
        ...
        if args.val_every > 0:
            if args.val_dataset:
                ...
                val_chunks = chunks
        print('The dataset you loaded has a total of', data_sampler.total_size, 'tokens. AI training will begin shortly...')
        print('AI training is now in progress. Updates on its loss score will be posted below as rounds of training reach completion...')
        ...
        def save():
            ...
            print(
                'Saving your files in the following directory:',
                os.path.join(CHECKPOINT_DIR, args.run_name,
        ...
        def generate_samples():
            print('This AI is now generating serendipitous examples from the training data. This may take several minutes depending on how fast your computer is...')
            ...
            while index < args.sample_num:
                ...
                for i in range(min(args.sample_num - index, args.batch_size)):
                    ...
                    text = '======== EXPERIMENTAL OUTPUT | AI IN TRAINING {} ========\n{}\n'.format(
                        index + 1, text)
        ...
        try:
            ...
            print('You have stopped the training process.')
            save()
